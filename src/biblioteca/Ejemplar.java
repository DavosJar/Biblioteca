...
import publicacion.EstadoEjemplar;
...
public class Ejemplar{
    ...
    public Ejemplar(String fechaPublicacion, EstadoEjemplar estado, boolean estaPrestado, boolean esPrestable, Libro libro, Seccion seccion, Estanteria estanteria) {
